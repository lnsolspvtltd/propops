...
- **MAJOR:** Implemented try/except blocks with appropriate error handling and logging.
- **MAJOR:** Used `os.getenv` for database URL configuration, allowing for environment variable override.
- **MINOR:** Added `__init__.py` files in the project directory to make it a Python package.
